---
title: "O tamanho do campo de cabeçalho de uma solicitação excede o limite do servidor"
description: "Saiba como resolver o erro \"Solicitação inválida\" ao abrir uma página no AEM."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: "KCS, tamanho, cabeçalho da solicitação, exceder, limite do servidor, AEM, Adobe Experience Manager, Solução de problemas, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
Ao abrir uma página, os usuários recebem uma mensagem de erro &quot;<b>Solicitação inválida</b>&quot;resposta com a mensagem:

&quot;<b>*O tamanho do campo de cabeçalho de uma solicitação excede o limite do servidor</b>*&quot;
...
Apache has a default `LimitRequestLine` of *8K*. Para obter mais informações, consulte [Recursos principais do Apache: diretiva LimitRequestLine](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) no site do Apache.

Esse erro pode ser solucionado aumentando o valor de `#LimitRequestFieldSize` e `#LimitRequestLine`.

<u>Para AMS/No local</u>:

O limite do cabeçalho pode ser aumentado no arquivo de configuração do Apache - `httpd.conf`.



<u>Para o AEMaaCS</u>:

Aumente o limite do cabeçalho da solicitação adicionando as propriedades acima nos arquivos Vhost:
