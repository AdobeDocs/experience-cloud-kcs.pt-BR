...
[&lt;- Anterior: Layout básico do arquivo](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17502.html)
...
Como você pode ver acima, isso inclui o nível superior `dispatcher.any` arquivo para que o módulo do dispatcher selecione os arquivos de configuração de `/etc/httpd/conf.dispatcher.d/dispatcher.any`
...
![Esta imagem mostra como um arquivo .vhost inclui arquivos de variáveis, listas de permissões e pastas de regravação](assets/Apache-Webserver-AMS-Vhost-Includes.png "Apache-Webserver-AMS-Vhost-Includes")
...
[Próximo -> Noções básicas sobre cache](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17912.html)