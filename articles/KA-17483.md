...
Este documento descreverá quais arquivos estão bloqueados e não devem ser alterados e como fazer as configurações desejadas corretamente no Adobe Experience Manager.
...
Copiamos o existente `aem_publish.vhost` porque ele já tem o que precisamos para fazer as coisas funcionarem e não queremos reinventar um início já forte.  Agora editamos o novo arquivo weretail.vhost e fazemos as alterações necessárias.
