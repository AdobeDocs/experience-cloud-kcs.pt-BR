...
description: "Saiba como analisar problemas de indexação do AEM."
...
- Se a reindexação não for concluída e entrar em um loop, consulte a seção abaixo intitulada [Análise de reindexação com falha](https://helpx.adobe.com/experience-manager/kb/Analyzing-AEM-Indexing-Issues.html#Analyzing_Failed_Reindexing).
