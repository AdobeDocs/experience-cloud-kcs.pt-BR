...
2. Fazer upload do arquivo jar para o servidor do AEM.
3. Parar o AEM (instâncias de origem e de destino).
...
4. Adicione um filtro à configuração de pacote para `/home/users` com essas regras de exclusão (no filtro `/home/users`):
...
5. Clique em Editar.
6. Clique na guia Avançado (veja a captura de tela abaixo).
