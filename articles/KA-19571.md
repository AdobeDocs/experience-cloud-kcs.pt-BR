...
3. Preencha os valores a seguir e selecione o botão &quot;salvar&quot;

Exemplo de configuração:    - loglevel = DEBUG - logfile = logs/activity.log - logger = org.apache.jackrabbit.vault.packaging.impl.ActivityLog

4. Instalar o service pack
