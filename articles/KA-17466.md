...
description: "Explore a otimização do desempenho do AEM com dicas sobre teste de carga, parâmetros JVM, ajuste de cache e otimização de armazenamento para o uso eficiente do AEM."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager 6.4,Experience Manager 6.5"
keywords: "KCS, Ajuste de Desempenho SQL, sistema ETL, AEM, Repositório Oak, XFS, Código da Aplicação, Armazenamento em Cache, service packs AEM, Versão do Oak, Parâmetros JVM"
