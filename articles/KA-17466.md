...
11. Ajuste do armazenamento Mongo
   ...
   - <b>Implemente a lista de verificação de produção MongoDB:</b>\
      [http://docs.mongodb.org/manual/administration/production-checklist/](http://docs.mongodb.org/manual/administration/production-checklist/) - de acordo com o apoio do Mongo DB, muitos dos itens têm um grande impacto no desempenho. Em caso de dúvidas, entre em contato diretamente com o Suporte MongoDB.
