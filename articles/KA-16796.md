---
title: "Como redefinir a truststore em AEM"
...
Não é possível recuperar erros de truststore vistos no log.
...
2. Excluir o nó `/etc/truststore/truststore.p12`.

3. Clique em <b>[!UICONTROL Salvar tudo]</b>.

4. Recrie o truststore de acordo com as instruções abaixo:
