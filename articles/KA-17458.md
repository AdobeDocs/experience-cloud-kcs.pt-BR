...
Funcionamento do armazenamento em cache do Dispatcher
...
5. <b>Páginas de erro de cache</b> - Aproveite o <b>[DispatcherPassError 1](https://helpx.adobe.com/br/experience-manager/dispatcher/using/dispatcher-install.html#ApacheWebServer) </b>(Específica do Apache Web Server) para servir páginas de erro, como 404s, do cache do dispatcher.
...
7. <b>Ativar [/serveStaleOnError](https://helpx.adobe.com/br/experience-manager/kb/ServeStaleContentOnError.html)</b> na configuração /cache - exibe o arquivo de cache antigo quando instâncias AEM exibem erros.
...
Uma explicação mais detalhada da recuperação de limpeza
