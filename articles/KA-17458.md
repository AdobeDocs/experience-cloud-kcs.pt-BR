...
11. <b>Armazenar conteúdo em cache o máximo possível</b> e <b>reduzir solicitações que retornam ao AEM</b> - Otimize as solicitações de liberação ativando a liberação de busca em todos os agentes de limpeza. Consulte a seção abaixo intitulada *Recuperando a liberação do Dispatcher*. Ou use [<b>/enableTTL</b>](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html#use-ttls) e definir <b>Controle de cache: max-age=...</b> para armazenar arquivos em cache o máximo possível.  Consulte [abaixo](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html#use-ttls) para obter detalhes sobre este tópico.
...
3. Em cada uma das configurações do agente, defina <b>Triggers</b> =`>`  <b>Ignorar padrão </b>para habilitado. Essa opção faz com que os agentes de limpeza sejam ignorados quando os usuários clicam em <b>Publicar/Cancelar publicação </b>ou <b>Ativar/Desativar</b> na interface do usuário do AEM.
