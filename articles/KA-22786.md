...
Ao tentar acessar o console de ativos do AEM usando &quot;/assets.html/content/dam&quot;, a tela fica em branco.
...
Ao verificar o log de erros, o erro `[` 1`]`  foi encontrado.

As interfaces do usuário do Assets e Sites devem pesquisar o status do fluxo de trabalho dos itens que estão listando. Portanto, se houver muitas instâncias de fluxo de trabalho, a página não será carregada e ocorrerá um erro `[` 1`]`  estará presente nos logs
