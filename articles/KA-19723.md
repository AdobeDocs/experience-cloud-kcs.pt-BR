---
title: Não é possível migrar o conteúdo do AEM 6.1 para o 6.5
...
# Não é possível migrar o conteúdo do AEM 6.1 para o 6.5

## Descrição


O rastreamento de pilha a seguir é lançado quando durante AEM migração do conteúdo v6.1 para 6.5:
...
Migrar para AEM v6.3 primeiro depois para 6.5.
