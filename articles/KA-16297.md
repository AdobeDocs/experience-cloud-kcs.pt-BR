---
title: Busca do modelo de AEM a partir de [!DNL Campaign] console
...
# Busca do modelo de AEM a partir de [!DNL Campaign] console

## Descrição


Descrição do problema = Ao sincronizar AEM modelos para [!DNL Campaign], recebemos o seguinte erro:
...
Os direitos de replicação precisam ser concedidos ao usuário AEM do campaign, em AEM servidor.  Demos direitos de leitura/gravação/replicação ao [!DNL Campaign]O usuário AEM em /content/campaign e /content/dam caminhos onde os ativos da campanha estavam presentes.
