...
<b><u>Causa:</u></b>  `con` é uma palavra-chave reservada em [!DNL Windows]

<b><u>Resolução:</u></b>

Em [!DNL Microsoft Windows], você não pode criar pastas ou ter extensões com as palavras abaixo.

`CON, PRN, AUX, NUL, COM1, COM2, COM3, COM4, COM5, COM6, COM7, COM8, COM9, LPT1, LPT2, LPT3, LPT4, LPT5, LPT6, LPT7, LPT8, and LPT9`

Essas são palavras-chave reservadas em [!DNL Windows]. Portanto, nomear uma instância com esses nomes dará um erro ao atualizar como uma pasta com um nome de instância é criada em seu sistema.
