...
  
Detalhes internos sugerem um problema de resposta HTTP com uma mensagem indicando &quot;Não encontrado&quot;, o que normalmente implicaria que o endpoint para a instância do autor não estava acessível durante a execução do teste.
...
No entanto, o usuário do cloudmanager existe e o upload manual de ativos no autor funciona conforme esperado.

O teste de desempenho de ativos está funcionando por 30 minutos e repentinamente falha de maneira repetida, enquanto o teste deve parar após 30 minutos - `[` 1`]`
...
Verificando os logs internos da função do Azure, foi encontrada a solicitação que teve o resultado 404 Não encontrado.

A GET para o URL do campo &quot;mensagem&quot; retornou 404 `[` 1`]` .
...
No entanto, o Cloud Manager precisa que o querybuilder seja permitido no dispatcher para o usuário do cloudmanager, pois, durante o teste de ativo, ele recupera o tempo de processamento.
