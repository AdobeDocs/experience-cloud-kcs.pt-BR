...
[&lt;- Anterior: O que é &quot;O Dispatcher&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17911.html)

## Descrição

Este documento explicará o conjunto de arquivos de configuração padrão do AMS e o raciocínio por trás desse padrão de configuração
...
[Next -> Explicação dos arquivos de configuração](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17477.html)