...
3. abra as propriedades da página de */content/we-retail/language-principal/en/women*
...
8. no *Miniatura* clique em *Gerar visualização* e salvar a alteração
...
Esse problema ocorre durante a implantação, pois o AEM não é capaz de criar o nó &quot;dam:thumbnails&quot; abaixo de jcr:content para a página de live copy (/content/we-retail/us/en/women/jcr:content/image/file/jcr:content) e o motivo para isso é durante a implantação mixinType &quot;dam:Thumbnails&quot; não é aplicado ao nó de varejo da página de live copy &quot;/content/we-we-we /us/en/women/jcr:content/image/file/jcr:content&quot; e a pasta &quot;dam:Thumbnails&quot; só podem ser criadas abaixo de &quot;dam:Thumbnails&quot; nodeType.

O comportamento padrão do MSM é ignorar a nova mixin adicionada aos nós na origem durante a implantação 0 e, portanto, não é adicionada a &quot;/content/we-retail/us/en/women/jcr:content/image/file/jcr:content&quot;.
