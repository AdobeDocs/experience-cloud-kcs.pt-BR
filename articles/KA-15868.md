...
Alguns motivos para erro exibido na publicação de segmentos do Analytics no Experience Cloud.


## Resolução


1. Descrição ausente: a descrição do segmento é obrigatória para publicar um segmento do Analytics no Experience Cloud.
