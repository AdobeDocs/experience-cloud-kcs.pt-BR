...
Ao clicar em um link na página, o Activity Map armazena os dados do link em um cookie próprio. Em seguida, defina como variáveis de dados de contexto de Activity Map que serão enviadas com [!DNL Analytics] exibição de página na página subsequente.
