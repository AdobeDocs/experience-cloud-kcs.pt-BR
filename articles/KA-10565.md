---
title: Não é possível se conectar ao Brand Portal com o erro "JWT expirou" | AEM
description: Saiba como solucionar problemas de pós-configuração da integração do Adobe Experience Manager (AEM) Assets com o Brand Portal.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager Assets,Experience Manager
keywords: KCS, conexão, Brand Portal, agente de replicação, JWT expirou, AEM, Adobe Experience Manager, 6.2, erro, JSON Web Token
...
# Não é possível se conectar ao Brand Portal com o erro &quot;JWT expirou&quot; | AEM


Depois de configurar a integração do Adobe Experience Manager (AEM) Assets com o Brand Portal, se você encontrar a mensagem de erro *O JWT expirou*, você deve alterar a hora do Sistema Operacional para uma hora válida ou usar o NTP (Network Time Protocol).
...
Após a configuração da integração do AEM Assets com o Brand Portal, aqui em [Visão geral do Experience Manager Assets Brand Portal: configurar o Experience Manager Assets com o Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/introduction/brand-portal#configure-brand-portal) na Documentação do AEM,



<b>Testar conexão</b> no agente de replicação retorna as mensagens de erro semelhantes a estas:
...
<b>Causa:</b>
A causa é a diferença de tempo entre a instância do AEM e a nuvem do Brand Portal.

A diferença causa a expiração do JWT (JSON Web Token).


<b>Solução:</b>
<b>Siga estas etapas:</b>

1. Confirme a hora do AEM no sistema operacional.
2. Altere o horário para um horário válido ou use o NTP (Network Time Protocol).
