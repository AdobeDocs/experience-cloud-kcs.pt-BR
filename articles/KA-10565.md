...
keywords: KCS, connect, Brand Portal, agente de replicação, JWT expirou, AEM, Adobe Experience Manager, 6.2, erro
...
A diferença causa a expiração da JWT.
...
2. Altere a hora para uma hora válida ou use ntp.
