...
keywords: KCS, conexão, Brand Portal, agente de replicação, JWT expirou, AEM, Adobe Experience Manager, 6.2, erro
...
1. Confirme a hora do SO do AEM.
2. Altere o horário para um horário válido ou use ntp.
