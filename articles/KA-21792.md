...
Na versão 2023.02.11382, foram feitos alguns aprimoramentos na implementação do GraphQL (Open-Source Query Language) que podem causar comportamento inesperado no código do aplicativo, caso ele tenha dependido do comportamento incorreto das versões mais antigas. 
