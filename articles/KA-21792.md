...
<b><u>Alterações na manipulação de GraphQL <em>null</em> values</u></b><br><br> <br><br>Na versão 2023.02.11382, foram feitos alguns aprimoramentos na implementação do GraphQL que podem causar comportamento inesperado no código do aplicativo, caso ele tenha dependido do comportamento incorreto das versões mais antigas. 
...
O último problema também está relacionado a *null* em condições de filtro em campos de vários valores. INSTÂNCIAS do modo de aplicação com _instâncias: 0 não correspondia aos fragmentos de conteúdo que contêm *null* no respectivo campo antes de 2023.02.11382, mas iniciará com 2023.02.11382. É recomendável testar os queries que usam essa constelação e alterá-los se não retornarem o resultado esperado definido em 2023.02.113 Mais 82.
<b>Exemplo:</b>
