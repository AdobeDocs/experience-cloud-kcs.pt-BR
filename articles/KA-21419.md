---
title: "A implantação do pipeline está falhando durante a etapa de build"
...
# A implantação do pipeline está falhando durante a etapa de build

## Descrição {#description}


<b>Descrição</b> : A execução do pipeline está falhando durante a etapa de build devido a erros no código ui.frontend

Você observa mensagens de ERRO como as abaixo no arquivo build.log:
...
- localize na raiz do git repo o arquivo pom.xml e localize a versão do nó, por exemplo: nodeVersionv10.13.0/nodeVersion

- localize ui.frontend/package.json e adicione o objeto devDependencies já presente: por exemplo:
...
Observação:
1. o v de nodeVersionv10.13.0 não deve ser copiado.
