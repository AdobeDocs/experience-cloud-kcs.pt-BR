...
É possível ver as Referências locais de um ativo em [!UICONTROL Referências] guia de [!UICONTROL Propriedades]. (Em [!DNL Assets] No console, selecione um ativo, selecione [!UICONTROL Propriedades] na barra de ferramentas e selecione [!UICONTROL Referências] guia .) Ao usar as informações fora do AEM, você pode exportá-las no formato JSON.
...
Acessar o seguinte URL &#39;1&#39; retorna Referências locais no formato JSON. `path` na resposta são os caminhos de conteúdo que fazem referência a um ativo de destino.
