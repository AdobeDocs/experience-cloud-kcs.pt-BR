...
Este é um comportamento codificado. O `com.day.cq.wcm.foundation.impl.PageRedirectServlet#doGet` está adicionando *.html* para o URL de redirecionamento se o destino de redirecionamento for um espaço dentro do mesmo AEM.
