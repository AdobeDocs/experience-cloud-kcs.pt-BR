...
[&lt;- Anterior: Liberação do Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17493.html)
...
![Menu suspenso de diálogo para a interface de criação de AEM na tela do editor do site](assets/aem-page-properties-drop-down.png "aem-page-properties-drop-down")![página de diálogo propriedades da página aem](assets/aem-page-properties.png "aem-page-properties")

#### Localizador de conteúdo clássico:

![AEM propriedades da página de sidekick clássica do siteadmin](assets/aem-page-properties-sidekick.png "aem-page-properties-sidekick")![Caixa de diálogo Propriedades da página da interface clássica](assets/aem-page-properties-classic.png "aem-page-properties-classic")
...
![captura de tela do console de uma entrada personalizada nas regras de resolução de recursos](assets/vanity-resource-resolver-entry.png "vanity-resource-resolver-entry")
...
![captura de tela do conteúdo renderizado de /libs/granite/dispatcher/content/vanityUrls.html](assets/vanity-url-component.png "vanity-url-component")
...
[Próximo -> Registro comum](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html)