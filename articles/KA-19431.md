---
title: Can [!DNL Litmus] A integração pode ser movida de produto para preparo
...
# Can [!DNL Litmus] A integração pode ser movida de produto para preparo
...
Não, [!DNL Litmus] A integração não pode ser movida de Prod para Staging nem pode ser feita no preparo.
