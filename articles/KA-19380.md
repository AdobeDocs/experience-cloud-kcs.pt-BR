...
Você pode receber o seguinte erro ao clicar no link de aprovação no email.
...
Os operadores precisam ter acesso ao [!UICONTROL Workflows da campanha] pasta em [!UICONTROL Administração] - [!UICONTROL Produção] - [!UICONTROL Objetos criados automaticamente] caminho.
