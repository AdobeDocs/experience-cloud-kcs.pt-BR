...
description: Explore o intrincado processo de liberação de cache e ativação de conteúdo, garantindo atualizações contínuas e desempenho ideal no sistema.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: KCS, mecanismo de liberação de cache, fluxo de trabalho do Dispatcher, agentes de Replicação, Processo de ativação, Manuseio de solicitação de liberação, Tipo de serialização, Configuração do Dispatcher, método HTTP para solicitações de liberação, Estrutura do arquivo Stat, Handshake de carimbo de data e hora, Exemplos de handshake de cache, Configurações do arquivo de farm
...
<br><br>Como funciona<br>
<b>Ordem de operação</b>

O fluxo de trabalho típico é melhor descrito quando os autores de conteúdo vão ativar uma página, quando o publicador recebe o novo conteúdo, ele aciona uma solicitação de liberação para o dispatcher, conforme mostrado no diagrama a seguir:![](assets/___c36d65be-9217-ef11-9f8a-6045bd006793___.png)
...
<br><br><br><br>Configurações do arquivo farm<br><br><br><br>
