...
onde o caminho do nó corrompido é o caminho obtido na etapa 2, por exemplo: &quot;/content/dam/test.txt/jcr:content/renditions/original/jcr:content/&quot; Observação: ao usar o oak-run.jar versão 1.6.13 e superior, defina o parâmetro —read-write JVM se você encontrar um erro como:
...
1. Execute uma limpeza de ponto de verificação listando pontos de verificação seguindo as etapas abaixo. Se houver mais de um ponto de verificação, limpe-os:
   ...
   ```
2. Execute uma compactação offline.  Caso não saiba como executar a compactação offline, consulte [aqui](https://gist.github.com/andrewmkhoury/0b1fe4d8b619178ff87b).
3. Inicie o servidor e aguarde a conclusão da indexação.
