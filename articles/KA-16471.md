...
Ao criar um público-alvo do Adobe Experience Cloud, há três opções.
...
Em caso de dúvidas sobre esse conteúdo ou público-alvo do Experience Cloud em geral, acesse o [fóruns da comunidade](http://help-forums.adobe.com/content/adobeforums/en/marketing-cloud-forum/audiences.html?cid=kb).
