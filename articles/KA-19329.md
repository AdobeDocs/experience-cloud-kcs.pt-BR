...
O cliente está relatando uma mensagem que não está internacionalizada. A mensagem de erro &quot;Invalid date - The value must be of date datatype&quot; está em inglês, mesmo que devesse estar em alemão, que é o idioma do navegador do cliente.
