---
title: "Noções básicas sobre cache | AEM"
description: "Saiba como ocorre o armazenamento em cache do dispatcher e como ele pode ser configurado no Adobe Experience Manager."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: "KCS, Armazenamento em cache, Armazenamento em cache do Dispatcher, AEM, Experience Manager"
...
# Noções básicas sobre armazenamento em cache | AEM


Neste artigo, você aprenderá como ocorre o armazenamento em cache do dispatcher e como configurá-lo usando os seguintes diretórios de cache padrão nas instalações de linha de base:
...
Queremos tornar nosso site publicado o mais ganancioso possível e armazenar tudo em cache.
