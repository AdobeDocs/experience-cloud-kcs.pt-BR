...
keywords: KCS, ACC, Adobe Campaign Classic, arquivos JAR não encontrados, OOO_INSTALL_DIR, processo WEB, reiniciar, erro, tag classpath, atualização, arquivo de configuração serverConf.xml
