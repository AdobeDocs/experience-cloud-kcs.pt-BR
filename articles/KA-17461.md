...
1. Se o site tiver conteúdo personalizado/dinâmico:
   ...
   1. Use [[!DNL Apache] Inclusões dinâmicas do Sling](https://helpx.adobe.com/experience-manager/kt/platform-repository/using/sling-dynamic-include-technical-video-setup.html) para dividir o conteúdo para que diferentes partes da página possam ser armazenadas em cache por diferentes períodos de tempo.
